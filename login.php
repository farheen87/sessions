<?php
session_start();
$con=mysql_connect("localhost","root","") or die("not connected to server");
$my_db=mysql_select_db("aptech",$con) or die(mysql_error());
  ...
  <div class="content">
    ...
    <form id="form1" name="form1" method="post" action="">
      <p>
        ...
        <input type="text" name="txtname" id="txtname" tabindex="1" />
      </p>
      <p>
      ...
      <p>
        <input type="submit" name="btnsubmit" id="btnsubmit" value="Submit" tabindex="3" />
